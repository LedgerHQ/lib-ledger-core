...
const EVENT_CODE = {
    ...
    NEW_BLOCK: 3,
    DELETED_OPERATION: 4,
    SYNCHRONIZATION_STARTED: 5,
    SYNCHRONIZATION_FAILED: 6,
    SYNCHRONIZATION_SUCCEED: 7,
    SYNCHRONIZATION_SUCCEED_ON_PREVIOUSLY_EMPTY_ACCOUNT: 8,
    NEW_ERC20_OPERATION: 9,
    UPDATE_ERC20_OPERATIONS: 10,
}
