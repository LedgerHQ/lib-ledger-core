...
*/
NJSPathResolverImpl.resolveDatabasePath = (path) => {
  //To Implement
}
/*
  ...
  @return: resolved path
*/
NJSPathResolverImpl.resolveLogFilePath = (path) => {
  //To Implement
}
/*
  ...
  @return: resolved path
*/
NJSPathResolverImpl.resolvePreferencesPath = (path) => {
  //To Implement
}
...
/*
  @param: message: NJSExecutionContext
*/
NJSLogPrinterImpl.getContext = () => {
  NJSLogPrinterImpl.context;
}
