...
namespace ledger {
        namespace testing {
                namespace cosmos {
                        ...
                        std::shared_ptr<core::cosmos::CosmosLikeAccount>
                        createCosmosLikeAccount(const std::shared_ptr<core::AbstractWallet>& wallet,
                                                int32_t index,
                                                const api::AccountCreationInfo &info) {
                                auto i = info;
                                i.index = index;
                                return std::dynamic_pointer_cast<core::cosmos::CosmosLikeAccount>(::wait(wallet->newAccountWithInfo(i)));
                        }
                        ...
                        createCosmosLikeAccount(const std::shared_ptr<core::AbstractWallet>& wallet,
                                ...
                                auto i = info;
                                i.index = index;
                                return std::dynamic_pointer_cast<core::cosmos::CosmosLikeAccount>(::wait(wallet->newAccountWithExtendedKeyInfo(i)));
                        }
