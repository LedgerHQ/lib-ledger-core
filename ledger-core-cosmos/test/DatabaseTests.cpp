...
public:
     ...
     const std::string& walletName)
 {
     ...
     wallet = std::dynamic_pointer_cast<CosmosLikeWallet>(
         wait(store->createWallet(walletName, "cosmos", configuration)));
...
TEST_F(CosmosDBTest, BasicDBTest) {
    std::shared_ptr<CosmosLikeAccount> account;
    std::shared_ptr<CosmosLikeWallet> wallet;
    setupTest(store, account, wallet, "90673bef-38d3-4a09-ad7c-f67dc4370210");
...
TEST_F(CosmosDBTest, OperationQueryTest) {
    std::shared_ptr<CosmosLikeAccount> account;
    std::shared_ptr<CosmosLikeWallet> wallet;
    setupTest(store, account, wallet, "38660eb1-2f89-4096-a8d5-fcaca0c44428");
...
TEST_F(CosmosDBTest, FeesMsgTypeFilteredOutTest) {
    std::shared_ptr<CosmosLikeAccount> account;
    std::shared_ptr<CosmosLikeWallet> wallet;
    setupTest(store, account, wallet, "f727a3d9-7e98-4bbf-b92c-c3976483ac89");
    ...
    {
        auto ops =
            wait(std::dynamic_pointer_cast<cosmos::CosmosLikeOperationQuery>(account->queryOperations()->complete())
                     ->execute());
...
TEST_F(CosmosDBTest, MultipleMsgTest) {
    std::shared_ptr<CosmosLikeAccount> account;
    std::shared_ptr<CosmosLikeWallet> wallet;
    setupTest(store, account, wallet, "ee64142f-a695-4755-9eb1-6c5a2a2291c3");
