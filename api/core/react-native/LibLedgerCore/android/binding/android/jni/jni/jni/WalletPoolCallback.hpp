...
private:
    ...
    const ::djinni::GlobalRef<jclass> clazz { ::djinni::jniFindClass("WalletPoolCallback") };
    const jmethodID method_onCallback { ::djinni::jniGetMethodID(clazz.get(), "onCallback", "(LWalletPool;LError;)V") };
};
