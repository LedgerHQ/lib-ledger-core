...
public class RCTCoreWalletListCallback extends WalletListCallback {
    ...
    public static RCTCoreWalletListCallback initWithPromise(Promise promise, (RCTBridge *) bridge)
    {
    ...
    public void onCallback(ArrayList<Wallet> result, Error error, ) {
        try
        {
            ...
            for (HashMap <String, String> result_elem : result)
            {
                ...
                RCTCoreWallet rctImpl_result_elem = (RCTCoreWallet)self.bridge moduleForName("RCTCoreWallet");
