...
public class RCTCoreAmountListCallback extends AmountListCallback {
    ...
    public static RCTCoreAmountListCallback initWithPromise(Promise promise, (RCTBridge *) bridge)
    {
    ...
    public void onCallback(ArrayList<Amount> result, Error error, ) {
        try
        {
            ...
            for (HashMap <String, String> result_elem : result)
            {
                ...
                RCTCoreAmount rctImpl_result_elem = (RCTCoreAmount)self.bridge moduleForName("RCTCoreAmount");
