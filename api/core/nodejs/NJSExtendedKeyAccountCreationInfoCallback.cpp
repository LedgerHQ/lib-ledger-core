...
void NJSExtendedKeyAccountCreationInfoCallback::onCallback(const std::experimental::optional<ExtendedKeyAccountCreationInfo> & result, const std::experimental::optional<Error> & error)
{
    ...
    for(size_t i = 0; i < (*result).extendedKeys.size(); i++)
    {
        auto arg_0_4_elem = Nan::New<String>((*result).extendedKeys[i]).ToLocalChecked();
    ...
    {
        Nan::ThrowError("NJSExtendedKeyAccountCreationInfoCallback::onCallback fail to retrieve node implementation");
    }
    ...
    {
        Nan::ThrowError("NJSExtendedKeyAccountCreationInfoCallback::onCallback call failed");
    }
}
