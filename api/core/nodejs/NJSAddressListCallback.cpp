...
void NJSAddressListCallback::onCallback(const std::experimental::optional<std::vector<std::shared_ptr<Address>>> & result, const std::experimental::optional<Error> & error)
{
    ...
    if(result)
    {
        ...
        {
            auto arg_0_tmp_elem_wrap = NJSAddress::wrap(arg_0_optional[arg_0_tmp_id]);
            auto arg_0_tmp_elem = Nan::ObjectWrap::Unwrap<NJSAddress>(arg_0_tmp_elem_wrap)->handle();
...
NAN_METHOD(NJSAddressListCallback::addRef) {

    NJSAddressListCallback *obj = Nan::ObjectWrap::Unwrap<NJSAddressListCallback>(info.This());
    obj->Ref();
}

NAN_METHOD(NJSAddressListCallback::removeRef) {
...
NAN_METHOD(NJSAddressListCallback::New) {
    ...
    NJSAddressListCallback *node_instance = new NJSAddressListCallback(resolver);
