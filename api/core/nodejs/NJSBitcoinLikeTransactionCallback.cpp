...
NAN_METHOD(NJSBitcoinLikeTransactionCallback::New) {
    ...
    NJSBitcoinLikeTransactionCallback *node_instance = nullptr;
    if(info[0]->IsObject())
    {
        node_instance = new NJSBitcoinLikeTransactionCallback(info[0]->ToObject());
    }
    else
    {
        return Nan::ThrowError("NJSBitcoinLikeTransactionCallback::New requires an implementation from node");
    }
