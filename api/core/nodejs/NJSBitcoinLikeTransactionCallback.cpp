...
NAN_METHOD(NJSBitcoinLikeTransactionCallback::New) {
    ...
    auto node_instance = std::make_shared<NJSBitcoinLikeTransactionCallback>(resolver);
    djinni::js::ObjectWrapper<NJSBitcoinLikeTransactionCallback>::Wrap(node_instance, info.This());
