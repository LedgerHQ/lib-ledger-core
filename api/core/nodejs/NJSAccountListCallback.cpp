...
void NJSAccountListCallback::onCallback(const std::experimental::optional<std::vector<std::shared_ptr<Account>>> & result, const std::experimental::optional<Error> & error)
{
    ...
    if(result)
    {
        ...
        {
            auto arg_0_tmp_elem_wrap = NJSAccount::wrap(arg_0_optional[arg_0_tmp_id]);
            auto arg_0_tmp_elem = Nan::ObjectWrap::Unwrap<NJSAccount>(arg_0_tmp_elem_wrap)->handle();
...
NAN_METHOD(NJSAccountListCallback::New) {
    ...
    NJSAccountListCallback *node_instance = new NJSAccountListCallback(resolver);
