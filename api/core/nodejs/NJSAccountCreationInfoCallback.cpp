...
void NJSAccountCreationInfoCallback::onCallback(const std::experimental::optional<AccountCreationInfo> & result, const std::experimental::optional<Error> & error)
{
    ...
    {
        Nan::ThrowError("NJSAccountCreationInfoCallback::onCallback fail to retrieve node implementation");
    }
    ...
    {
        Nan::ThrowError("NJSAccountCreationInfoCallback::onCallback call failed");
    }
}
