...
void NJSOperationListCallback::onCallback(const std::experimental::optional<std::vector<std::shared_ptr<Operation>>> & result, const std::experimental::optional<Error> & error)
{
    ...
    if(result)
    {
        ...
        {
            auto arg_0_tmp_elem_wrap = NJSOperation::wrap(arg_0_optional[arg_0_tmp_id]);
            auto arg_0_tmp_elem = Nan::ObjectWrap::Unwrap<NJSOperation>(arg_0_tmp_elem_wrap)->handle();
...
NAN_METHOD(NJSOperationListCallback::New) {
    ...
    NJSOperationListCallback *node_instance = new NJSOperationListCallback(resolver);
