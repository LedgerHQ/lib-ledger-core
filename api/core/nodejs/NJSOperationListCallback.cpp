...
void NJSOperationListCallback::onCallback(const std::experimental::optional<std::vector<std::shared_ptr<Operation>>> & result, const std::experimental::optional<Error> & error)
{
    ...
    {
        auto arg_0_elem = NJSOperation::wrap((*result)[i]);
    ...
    {
        Nan::ThrowError("NJSOperationListCallback::onCallback fail to retrieve node implementation");
    }
    ...
    {
        Nan::ThrowError("NJSOperationListCallback::onCallback call failed");
    }
}
