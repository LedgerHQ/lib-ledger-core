...
NAN_METHOD(NJSBitcoinLikeOutputListCallback::New) {
    ...
    auto node_instance = std::make_shared<NJSBitcoinLikeOutputListCallback>(resolver);
    djinni::js::ObjectWrapper<NJSBitcoinLikeOutputListCallback>::Wrap(node_instance, info.This());
