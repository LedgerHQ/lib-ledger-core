...
NAN_METHOD(NJSErrorCodeCallback::addRef) {

    NJSErrorCodeCallback *obj = Nan::ObjectWrap::Unwrap<NJSErrorCodeCallback>(info.This());
    obj->Ref();
}

NAN_METHOD(NJSErrorCodeCallback::removeRef) {
...
NAN_METHOD(NJSErrorCodeCallback::New) {
    ...
    NJSErrorCodeCallback *node_instance = new NJSErrorCodeCallback(resolver);
