...
private:
    ...
    const ::djinni::GlobalRef<jclass> clazz { ::djinni::jniFindClass("AccountCreationInfoCallback") };
    const jmethodID method_onCallback { ::djinni::jniGetMethodID(clazz.get(), "onCallback", "(LAccountCreationInfo;LError;)V") };
};
