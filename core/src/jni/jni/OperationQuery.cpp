...
CJNIEXPORT jobject JNICALL Java_OperationQuery_00024CppProxy_native_1offset(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jlong j_from)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::ledger::core::api::OperationQuery>(nativeRef);
...
CJNIEXPORT jobject JNICALL Java_OperationQuery_00024CppProxy_native_1limit(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jlong j_count)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::ledger::core::api::OperationQuery>(nativeRef);
