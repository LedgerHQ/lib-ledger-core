...
CJNIEXPORT jobject JNICALL Java_CosmosLikeTransactionBuilder_00024CppProxy_native_1setAccountNumber(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jstring j_accountNumber)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::ledger::core::api::CosmosLikeTransactionBuilder>(nativeRef);
...
CJNIEXPORT jobject JNICALL Java_CosmosLikeTransactionBuilder_00024CppProxy_native_1setGasAdjustment(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jdouble j_gasAdjustment)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::ledger::core::api::CosmosLikeTransactionBuilder>(nativeRef);
