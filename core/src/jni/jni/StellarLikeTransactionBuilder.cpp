...
CJNIEXPORT jobject JNICALL Java_StellarLikeTransactionBuilder_00024CppProxy_native_1putSignature(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jbyteArray j_signature)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::ledger::core::api::StellarLikeTransactionBuilder>(nativeRef);
