...
#ifndef DJINNI_GENERATED_BITCOINLIKEACCOUNT_HPP_JNI_
#define DJINNI_GENERATED_BITCOINLIKEACCOUNT_HPP_JNI_
...
#endif //DJINNI_GENERATED_BITCOINLIKEACCOUNT_HPP_JNI_
