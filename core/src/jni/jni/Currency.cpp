...
auto Currency::fromCpp(JNIEnv* jniEnv, const CppType& c) -> ::djinni::LocalRef<JniType> {
    ...
    auto r = ::djinni::LocalRef<JniType>{jniEnv->NewObject(data.clazz.get(), data.jconstructor,
                                                           ...
                                                           ::djinni::get(::djinni::Optional<std::experimental::optional, ::djinni_generated::AlgorandNetworkParameters>::fromCpp(jniEnv, c.algorandNetworkParameters)))};
...
auto Currency::toCpp(JNIEnv* jniEnv, JniType j) -> CppType {
    ...
    return {::djinni_generated::WalletType::toCpp(jniEnv, jniEnv->GetObjectField(j, data.field_walletType)),
            ...
            ::djinni::Optional<std::experimental::optional, ::djinni_generated::AlgorandNetworkParameters>::toCpp(jniEnv, jniEnv->GetObjectField(j, data.field_algorandNetworkParameters))};
}
