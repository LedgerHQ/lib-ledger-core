...
CJNIEXPORT jstring JNICALL Java_ERC20LikeOperation_00024CppProxy_native_1getETHOperationUid(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::ledger::core::api::ERC20LikeOperation>(nativeRef);
...
CJNIEXPORT jstring JNICALL Java_ERC20LikeOperation_00024CppProxy_native_1getOperationUid(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::ledger::core::api::ERC20LikeOperation>(nativeRef);
