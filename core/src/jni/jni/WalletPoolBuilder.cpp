...
CJNIEXPORT jobject JNICALL Java_co_ledger_core_WalletPoolBuilder_00024CppProxy_native_1setTracer(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jobject j_tracer)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::ledger::core::api::WalletPoolBuilder>(nativeRef);
        auto r = ref->setTracer(::djinni_generated::CoreTracer::toCpp(jniEnv, j_tracer));
        return ::djinni::release(::djinni_generated::WalletPoolBuilder::fromCpp(jniEnv, r));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, 0 /* value doesn't matter */)
}
