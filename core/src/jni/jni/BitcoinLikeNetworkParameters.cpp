...
auto BitcoinLikeNetworkParameters::fromCpp(JNIEnv* jniEnv, const CppType& c) -> ::djinni::LocalRef<JniType> {
    ...
    auto r = ::djinni::LocalRef<JniType>{jniEnv->NewObject(data.clazz.get(), data.jconstructor,
                                                           ...
                                                           ::djinni::get(::djinni::I64::fromCpp(jniEnv, c.Dust)),
                                                           ::djinni::get(::djinni_generated::BitcoinLikeDustPolicy::fromCpp(jniEnv, c.DustPolicy)),
...
auto BitcoinLikeNetworkParameters::toCpp(JNIEnv* jniEnv, JniType j) -> CppType {
    ...
    return {::djinni::String::toCpp(jniEnv, (jstring)jniEnv->GetObjectField(j, data.field_Identifier)),
            ...
            ::djinni::I64::toCpp(jniEnv, jniEnv->GetLongField(j, data.field_Dust)),
            ::djinni_generated::BitcoinLikeDustPolicy::toCpp(jniEnv, jniEnv->GetObjectField(j, data.field_DustPolicy)),
