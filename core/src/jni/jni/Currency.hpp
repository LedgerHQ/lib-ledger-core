...
private:
    ...
    const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), "<init>", "(LWalletType;Ljava/lang/String;ILjava/lang/String;Ljava/util/ArrayList;LBitcoinLikeNetworkParameters;LCosmosLikeNetworkParameters;LEthereumLikeNetworkParameters;LRippleLikeNetworkParameters;LTezosLikeNetworkParameters;)V") };
