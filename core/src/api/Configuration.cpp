...
std::string const Configuration::BLOCKCHAIN_EXPLORER_API_KEY = {"BLOCKCHAIN_EXPLORER_API_KEY"};
...
std::string const Configuration::QUERY_CONFIRMED_UTXO_FIRST = {"QUERY_CONFIRMED_UTXO_FIRST"};
