...
#ifndef DJINNI_GENERATED_COSMOSLIKEBLOCK_HPP
#define DJINNI_GENERATED_COSMOSLIKEBLOCK_HPP
...
class LIBCORE_EXPORT CosmosLikeBlock {
public:
    virtual ~CosmosLikeBlock() {}
...
#endif //DJINNI_GENERATED_COSMOSLIKEBLOCK_HPP
