...
extern template class ledger::core::common::PersistentBlockchainDatabase<ledger::core::BitcoinLikeNetwork>;
extern template class std::shared_ptr<ledger::core::common::PersistentBlockchainDatabase<ledger::core::BitcoinLikeNetwork>>;
