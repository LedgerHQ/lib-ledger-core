...
::google::protobuf::internal::SCCInfo<0> scc_info_Wallet_bitcoin_2fwallet_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsWallet_bitcoin_2fwallet_2eproto}, {}};

void InitDefaults_bitcoin_2fwallet_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_Wallet_bitcoin_2fwallet_2eproto.base);
}

::google::protobuf::Metadata file_level_metadata_bitcoin_2fwallet_2eproto[1];
constexpr ::google::protobuf::EnumDescriptor const** file_level_enum_descriptors_bitcoin_2fwallet_2eproto = nullptr;
constexpr ::google::protobuf::ServiceDescriptor const** file_level_service_descriptors_bitcoin_2fwallet_2eproto = nullptr;
...
::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_bitcoin_2fwallet_2eproto = {
  {}, AddDescriptors_bitcoin_2fwallet_2eproto, "bitcoin/wallet.proto", schemas,
  file_default_instances, TableStruct_bitcoin_2fwallet_2eproto::offsets,
  file_level_metadata_bitcoin_2fwallet_2eproto, 1, file_level_enum_descriptors_bitcoin_2fwallet_2eproto, file_level_service_descriptors_bitcoin_2fwallet_2eproto,
};
...
void AddDescriptors_bitcoin_2fwallet_2eproto() {
 ...
 ::google::protobuf::internal::AddDescriptors(&descriptor_table_bitcoin_2fwallet_2eproto, deps, 0);
}
...
class Wallet::HasBitSetters {
 public:
};

#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int Wallet::kUidFieldNumber;
const int Wallet::kNameFieldNumber;
...
const char* Wallet::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<Wallet*>(object);
...
::google::protobuf::Metadata Wallet::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_bitcoin_2fwallet_2eproto);
  return ::file_level_metadata_bitcoin_2fwallet_2eproto[kIndexInFileMessages];
}
