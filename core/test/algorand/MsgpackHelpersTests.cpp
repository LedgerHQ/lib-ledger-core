        ...
        namespace adaptor {
            ...
            namespace {
                ...
                class FooTest {
                  public:
                    FooTest(Option<double> f1,
                        ...
                        : f1(std::move(f1)), f2(f2), f3(std::move(f3)) {}
                ...
                bool operator==(const FooTest &f1, const FooTest1 &f2) {
                    return f1.f1.isEmpty() && f1.f2 == f2.f2 && f1.f3.isEmpty();
                }

                bool operator==(const FooTest &f1, const FooTest2 &f2) {
                    return f1.f1.nonEmpty() && f1.f1.getValue() == f2.f1 && f1.f2 == f2.f2 && f1.f3.isEmpty();
                }

                bool operator==(const FooTest &f1, const FooTest3 &f2) {
                    return f1.f1.isEmpty() && f1.f2 == f2.f2 && f1.f3.nonEmpty() && f1.f3 == f2.f3;
                }

                bool operator==(const FooTest &f1, const FooTest4 &f2) {
                    return f1.f1.nonEmpty() && f1.f1 == f2.f1 && f1.f2 == f2.f2 && f1.f3.nonEmpty() && f1.f3 == f2.f3;
                }
