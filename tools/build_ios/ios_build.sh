...
export POLLY_ROOT="/Users/elkhalilbellakrid/Desktop/Playground_04/lib-ledger-core/toolchains/polly"
...
#iOS simulator
cmake -GXcode -DCMAKE_OSX_ARCHITECTURES:STRING="x86_64" -DCMAKE_MACOSX_BUNDLE:BOOL=ON -DCMAKE_OSX_SYSROOT:STRING="iphonesimulator" -DCMAKE_TOOLCHAIN_FILE=../lib-ledger-core/toolchains/polly/ios-nocodesign-11-2-dep-9-3.cmake -DCMAKE_INSTALL_PREFIX=/usr/local/Cellar/qt/5.10.0_1 ../lib-ledger-core
